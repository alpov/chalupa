...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(LPUART1_DE_GPIO_Port, LPUART1_DE_Pin);

  /**/
  LL_GPIO_ResetOutputPin(LPUART1_TX_GPIO_Port, LPUART1_TX_Pin);
  ...
  /**/
  LL_GPIO_SetOutputPin(LPUART1_RE_GPIO_Port, LPUART1_RE_Pin);
  ...
  /**/
  GPIO_InitStruct.Pin = NTC_EN_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(NTC_EN_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = LPUART1_DE_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(LPUART1_DE_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = LPUART1_RE_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(LPUART1_RE_GPIO_Port, &GPIO_InitStruct);
  ...
  /**/
  LL_GPIO_SetPinPull(RFM_INT0_GPIO_Port, RFM_INT0_Pin, LL_GPIO_PULL_UP);

  /**/
  LL_GPIO_SetPinMode(RFM_INT0_GPIO_Port, RFM_INT0_Pin, LL_GPIO_MODE_INPUT);
